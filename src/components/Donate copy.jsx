      ...
      <ContentWrapper>
        <ContentBox>
          ...
          <Box sx={{ mb: 4 }}>
            ...
            <Box sx={{ height: { xs: '20vh', md: '25vh' }, overflow: 'hidden', borderRadius: '8px' }}>
              <ReactPlayer 
          ...
          <Button
            ...
            component={Link}
            to="https://buy.stripe.com/dR6cPH3O21Oz7U4288" // Replace with your payment portal link
            sx={{
              fontWeight: 'bold',
              textTransform: 'none',
              fontSize: { xs: '1rem', md: '1.25rem' }, // Adjust font size based on screen size
