  ...
  return (
    ...
    >
      <ReactPlayer
        ...
        playing
        loop
        muted // Ensure the video is not muted
        width="100%"
        height="100%"
        style={{
          position: 'absolute',
      ...
      >
        <Typography
          ...
          sx={{
            ...
            mb: 2,
            fontSize: { xs: '1.7rem', sm: '2rem', md: '3rem', lg: '4rem' }, // Adjust font size for all screen sizes
        ...
        <Typography
          ...
          sx={{
            fontFamily: 'Haettenschweiler',
            fontSize: { xs: '0.7rem', sm: '1rem', md: '1.5rem', lg: '2rem' }, // Responsive font sizes
            lineHeight: 1,
            mb: 4,
          }}
        >
